...
5. Khong commit secret Clerk that vao git. Local dung `.env.local`, Synology dung `.env.synology`.
6. Neu thay doi Clerk key, domain hoac callback URL, phai cap nhat dong bo trong file env cua tung moi truong va cac route auth lien quan.
