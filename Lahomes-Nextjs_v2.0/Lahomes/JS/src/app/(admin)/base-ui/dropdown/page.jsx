...
import { Button, Col, Dropdown, DropdownDivider, DropdownHeader, DropdownItem, DropdownMenu, DropdownToggle, FormCheck, FormControl, FormLabel, Row } from 'react-bootstrap';
...
const DropdownVariant = () => {
  return <ComponentContainerCard id="single-button-variant" title="Single Button Variant Dropdowns" description={<>
      ...
      <div className="d-flex flex-wrap gap-2">
        {colorVariants.slice(0, 4).map((color, idx) => <Dropdown key={idx} className="mb-2 me-1 d-inline-flex">
...
const DropdownDirection = () => {
  return <ComponentContainerCard id="direction" title="Dropdown Direction" description={<>
      ...
      <div className="d-flex flex-wrap gap-2">
        ...
        <Dropdown className="d-inline-flex" drop="up">
          <DropdownToggle variant="secondary" className="arrow-none icons-center gap-1">
        ...
        <Dropdown className="d-inline-flex" drop="start">
        ...
        <Dropdown className="d-inline-flex" drop="end">
...
const AutoCloseBehaviorDropdown = () => {
  return <ComponentContainerCard id="auto-close-behavior" title="Auto close behavior" description={<>
      ...
      <div className="d-flex flex-wrap gap-2">
        <Dropdown autoClose className="d-inline-flex">
          <DropdownToggle variant="secondary" className="arrow-none icons-center gap-1">
        ...
        <Dropdown autoClose="inside" className="d-inline-flex">
          <DropdownToggle variant="secondary" className="arrow-none icons-center gap-1">
