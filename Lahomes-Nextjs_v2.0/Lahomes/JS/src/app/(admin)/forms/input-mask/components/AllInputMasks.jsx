            ...
            <Col md={6}>
              <form action="#">
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="00:00:00" placeholder="HH:MM:SS" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask="00/00/0000 00:00:00" placeholder="DD/MM/YYYY HH:MM:SS" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask={Number} radix="," thousandsSeparator="." placeholder="0,00" className="form-control" />
                ...
                <div className="mb-3">
                  ...
                  <IMaskInput mask={Number} radix="," thousandsSeparator="." scale={2} placeholder="#.##0,00" className="form-control" />
