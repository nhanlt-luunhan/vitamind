...
const MapWithMarkers = () => {
  ...
  const onMarkerClick = (title, position) => {
    setInfoText(title);
  ...
  return <ComponentContainerCard id="google_map" title="Markers Google Map" description={<>
      ...
      height: 400
        ...
        <APIProvider apiKey={API_KEY}>
          <Map defaultZoom={18} defaultCenter={{
          lat: 21.569874,
          lng: 71.5893798
        }} style={{
          width: '100%',
          height: '100%'
            ...
            lat: 21.56969,
            lng: 71.5893798
          }} onClick={() => onMarkerClick('Current Location', {
            lat: 21.56969,
            lng: 71.5893798
          })}>
              <Pin background="blue" />
            ...
            {showInfo && <InfoWindow position={infoPosition} onCloseClick={() => setShowInfo(false)}>
                <div>
                  <p>{infoText}</p>
                </div>
              </InfoWindow>}
...
const StreetViewMap = () => {
  ...
  return <ComponentContainerCard id="street_view" title="Street View Panoramas Google Map" description={<>
      ...
      overflow: 'hidden'
        ...
        <APIProvider apiKey={API_KEY}>
          <Map zoom={14} mapId={'streetview'} defaultCenter={{
          lat: 40.7295174,
          lng: -73.9986496
        }} style={{
          width: '100%',
