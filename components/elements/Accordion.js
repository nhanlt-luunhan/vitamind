      ...
      <div className="accordion" id="accordionFaqs">
        <div className="accordion-item border-gray-800 wow animate__animated animate__fadeIn">
          <h2 className="accordion-header" onClick={() => handleToggle(1)}>
            ...
            >
              <span className="heading-4 color-white">
          ...
          <div
            className={
              isActive.key == 1 ? "accordion-collapse collapse show" : "accordion-collapse collapse"
            }
          >
            <div className="accordion-body">
              Nulla non sollicitudin. Morbi sit amet laoreet ipsum, vel pretium mi. Morbi varius,
              tellus in accumsan blandit, elit ligula eleifend velit, luctus mattis ante nulla
              condimentum nulla.
            </div>
          </div>
        </div>
        ...
        <div className="accordion-item border-gray-800 wow animate__animated animate__fadeIn">
          ...
          <div
            className={
              isActive.key == 2 ? "accordion-collapse collapse show" : "accordion-collapse collapse"
            }
          >
            <div className="accordion-body">
              Nulla non sollicitudin. Morbi sit amet laoreet ipsum, vel pretium mi. Morbi varius,
        ...
        <div className="accordion-item border-gray-800 wow animate__animated animate__fadeIn">
          ...
          <div
            className={
              isActive.key == 3 ? "accordion-collapse collapse show" : "accordion-collapse collapse"
            }
          >
            <div className="accordion-body">
              Nulla non sollicitudin. Morbi sit amet laoreet ipsum, vel pretium mi. Morbi varius,
        ...
        <div className="accordion-item border-gray-800 wow animate__animated animate__fadeIn">
          ...
          <div
            className={
              isActive.key == 4 ? "accordion-collapse collapse show" : "accordion-collapse collapse"
            }
          >
            <div className="accordion-body">
              Nulla non sollicitudin. Morbi sit amet laoreet ipsum, vel pretium mi. Morbi varius,
